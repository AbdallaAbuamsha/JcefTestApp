...
public class Ui extends JFrame  implements ApplicationRunner {

    @Value("${browser.starturl}")
    private String startUrl;
    private final boolean useOSR = false;
     ...
     */
    public Ui() throws UnsupportedPlatformException, CefInitializationException, IOException, InterruptedException {
